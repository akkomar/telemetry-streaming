...
cat << EOF
{
    ...
    "new_cluster": {
        ...
        "custom_tags": {
            ...
            "Env": "databricks-dev",
            "Type": "streaming",
            "TelemetryJobName": "experiment_enrollments_delta"
        }
    },
    "libraries": [{"jar": "s3://net-mozaws-data-us-west-2-ops-ci-artifacts/mozilla/telemetry-streaming/delta-test/telemetry-streaming.jar"}],
    "email_notifications": {
...
databricks jobs reset --job-id 483 --json "$(create_job_json)"
